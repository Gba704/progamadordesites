...
def sortear():
    ...
    def verificarEscolha(escolha):
        if escolha == numSorteado:
            ...
            messagebox.showerror("Perdeu!", "Computador sera desligado")
            time.sleep(5)
            ...
            messagebox.showerror("Ufa!", "Você está seguro por emqunto ")
    janela = tk.Toplevel()
...
def exibriRegras():
    regras = (
        ...
        "2. Se vpcê escolher o n sorteado o seu pc sera desligado \n"
...
tk.Button(root, text="Ver regras", width=20, command=exibriRegras).pack(pady=10)
